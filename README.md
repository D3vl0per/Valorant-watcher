...
7. install Chromium
7. Download and install Chromium (latest version) (from https://download-chromium.appspot.com/)
7. Extract the content of the chromium ZIP and copy the folder to where you would like to keep it (and note the path temporarily on a notepad)
7. Or download chrome canary (stable version) (from https://www.google.com/intl/en/chrome/canary/)
